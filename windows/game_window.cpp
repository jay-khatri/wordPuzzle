...
//------Constructor continued------------------------------------------------------------
{
	...
	stringstream ss_3;
	ss << top_three[0] << " " << top_three[1] << " " << top_three[2];
	player_scores_3(ss_3);

	attach(player_scores_4);
	vector<int> top_four = the_player.getScores(4);
	stringstream ss_4;
	ss << top_four[0] << " " << top_four[1] << " " << top_four[2];
	player_scores_4(ss_4);
	
	attach(player_scores_5);
	vector<int> top_five = the_player.getScores(5);
	stringstream ss_5;
	ss << top_five[0] << " " << top_five[1] << " " << top_five[2];
	player_scores_5(ss_5);
